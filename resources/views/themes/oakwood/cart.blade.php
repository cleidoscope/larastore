	...
	<div class="ui grid stackable">
					          	...
					          	<div class="content">
					            	...
					            	<div class="sub header">
					            		...
					            		@if( $product->discounted_price ) 
							      		<strong>{{ Helpers::currencyFormat($product->discounted_price) }}</strong> <br />
		...
		<div class="five wide tablet five wide computer column">
			<div class="ui segment text-center">
				...
				<div class="font-big font-bold margin-top margin-bottom" id="cart_total">{{ Helpers::cartTotalAmount() }}</div>
