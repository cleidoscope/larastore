                                ...
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        ...
                                        <p style="{{ $style['paragraph'] }}">
                                            Hi {{ $storeSubscriber->store->user->first_name }}, <br /><br />
                                            Your store <a style="{{ $style['anchor'] }}text-decoration: none;" href="{{ $storeSubscriber->store->url }}"><strong>{{ $storeSubscriber->store->name }}</strong></a> has a new subscriber.
                                        </p>

                                        <p style="color: #333;text-align: center;">
                                            <h4 style="margin: 0; text-align: center; font-size: 23px;">{{ $storeSubscriber->full_name }}</h4>

                                            <h4 style="margin: 0; text-align: center; font-size: 14px;">{{ $storeSubscriber->email }}</h4>
                                        </p>
