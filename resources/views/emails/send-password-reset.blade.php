...
$style = [
    ...
    'button' => 'display: inline-block; min-height: 20px; padding: 10px 30px;
                 background-color: #155d8c; border-radius: 3px; color: #ffffff; font-size: 15px; line-height: 25px;
                 text-align: center; text-decoration: none; -webkit-text-size-adjust: none; width: auto; max-width:100%;',
                            ...
                            <table style="{{ $style['email-body_inner'] }}" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        ...
                                        <!-- Action Button -->
                                        @if (isset($actionUrl))
                                        <table style="{{ $style['body_action'] }}" align="center"cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="center">
                                        ...
                                        <!-- Outro -->
                                        <p style="{{ $style['paragraph'] }}">
                                            If you did not request a password reset, please contact us at <a href="mailto:support@cloudstore.ph">support@cloudstore.ph</a> to secure your account.
                                        </p>
