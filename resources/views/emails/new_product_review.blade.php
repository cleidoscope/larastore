                                ...
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        ...
                                        <p style="{{ $style['paragraph'] }}">
                                            Hi {{ $productReview->product->store->user->first_name }}, <br /><br />
                                            Your product <a style="{{ $style['anchor'] }}text-decoration: none;" href="{{ $productReview->product->store->url }}{{ $productReview->product->url }}"><strong>{{ $productReview->product->title }}</strong></a> has a new review.
                                        </p>
                                        ...
                                        <p style="{{ $style['paragraph'] }}">
                                           Ratings: <strong>{{ $productReview->rating }}</strong> <br />
                                           Comment: <strong><em>{{ $productReview->comment }}</em></strong> <br />
                                           Author: <strong>{{ $productReview->user->initial_name }}</strong>
                                        </p>
